...
```bash
curl -L https://github.com/alphaxsalt/vsc-snippet-catalog/releases/latest/download/commandvault.vsix -o /tmp/commandvault.vsix && code --install-extension /tmp/commandvault.vsix
```
